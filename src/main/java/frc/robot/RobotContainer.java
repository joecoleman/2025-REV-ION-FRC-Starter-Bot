...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    // X Button -> Elevator/Arm to human player position, set ball intake to stow
    // when idle
    ...
    // Y Button -> Elevator/Arm to level 2 position
    m_operatorController.y().onTrue(m_coralSubSystem.setSetpointCommand(Setpoint.kLevel2));
    ...
    // a Button -> Elevator/Arm to level 4 position
    m_operatorController.a().onTrue(m_coralSubSystem.setSetpointCommand(Setpoint.kLevel4));
